...
namespace jank::runtime::detail
{
                                     ...
                                     object_ref const value)
  {
    ...
    switch(length)
    {
      ...
      case 10:
        {
          auto const ret(JANK_NEW_GC object_ref[12]{ prev[0],
                                                     prev[1],
                                                     prev[2],
                                                     prev[3],
                                                     prev[4],
      ...
      case 12:
        {
          auto const ret(JANK_NEW_GC object_ref[14]{ prev[0],
                                                     prev[1],
                                                     prev[2],
                                                     prev[3],
                                                     prev[4],
      ...
      case 14:
        {
          auto const ret(JANK_NEW_GC object_ref[16]{ prev[0],
                                                     prev[1],
                                                     prev[2],
                                                     prev[3],
                                                     prev[4],
  ...
  void native_array_map::reserve(u8 const size)
  {
    ...
    auto const new_data{ JANK_NEW_GC object_ref[new_capacity]{} };
  ...
  native_array_map native_array_map::clone() const
  {
    ...
    ret.data = JANK_NEW_GC object_ref[cap];
    for(u8 i{}; i < length; ++i)
    {
      ret.data[i] = data[i];
    }
